...
export function Header() : React.JSX.Element {
  return <><a className="skip-link" href="#conteudo">Pular para o conteúdo</a><header className="header shell"><Wordmark /><nav aria-label="Navegação principal"><Link href="/#como-funciona">Como funciona</Link><Link href="/manual">Manual técnico</Link><a className="github-link" href={REPOSITORY} target="_blank" rel="noreferrer" aria-label="Repositório da Workflow no GitHub"><GithubIcon /></a><MotionToggle compact /></nav></header></>;
}
